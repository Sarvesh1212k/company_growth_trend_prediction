...
def get_connection():
    return mysql.connector.connect(
        host="sql12.freesqldatabase.com",   # your remote host
        user="sql12797789",                 # your remote username
        password="cDK2JEqkn2",        # your remote password
        database="sql12797789"              # your remote DB name
    )
# --------- CHAT HISTORY ----------
