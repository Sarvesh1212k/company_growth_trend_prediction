...
#         st.session_state.dashboard_symbol = None
...
#         value=st.session_state.dashboard_link,
...
#             revenue = financials.get("Total Revenue", pd.Series(dtype=float))
#             profit = financials.get("Gross Profit", pd.Series(dtype=float))
#             if revenue is None or revenue.empty or profit is None or profit.empty:
#                 return None, company_name
...
#     # ----------------- FETCH DATA -----------------
#     if link and link != st.session_state.dashboard_link:
#         # New link entered
#         st.session_state.dashboard_link = link
#         try:
...
#     if st.session_state.dashboard_link and st.session_state.dashboard_df is None:
#         symbol = extract_symbol_from_link(st.session_state.dashboard_link)
#         if symbol:
...
#     symbol = st.session_state.get("dashboard_symbol")
