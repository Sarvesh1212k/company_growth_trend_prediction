...
def show():
    ...
    <div class="card-container">
        ...
        <div class="card">
            <h3>Technologies</h3>
            <p>Python, Streamlit, MySQL, Pandas, Plotly, scikit-learn, and HTML/CSS.</p>
        </div>
        <div class="card">
            <h3>Navigation</h3>
        ...
        <div class="card">
            <h3>Data Sources</h3>
            <p>Data from user inputs, company databases, and external financial APIs.</p>
        </div>
        <div class="card">
            <h3>Future Enhancements</h3>
            <p>AI-based analytics, automated reports, and responsive mobile view.</p>
        </div>
    </div>
    """
